...
define([
  ...
  "./js/properties",
  "./js/helpers",
  "./css/qlik-on-demand-reporting.css",
  "./template/view-main-single.html",
  "./template/view-popup.html",
  './template/view-senseid-mismatch-popup.html',
  "qvangular"
], function ($, qlik, properties, hlp, css, viewMain, viewPopup, senseIdMismatchPopup, qvangular) {
        ...
        qvangular.getService("luiDialog").show({
          ...
          controller: ["$scope", "$interval", function ($scope, $interval) {
            ...
            $scope.downloadTask = function (taskId) {
              ...
              hlp.downloadTask(conn.server, taskId).then(function () {
